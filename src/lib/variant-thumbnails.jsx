...
export const VARIANT_THUMBNAILS = {
  ...
  cta: {
    ...
    19: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col p-1.5 rounded-[3px] overflow-hidden justify-between" style={{ background: accent }}>
    ...
    20: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col items-center justify-center rounded-[3px] overflow-hidden p-2 relative bg-zinc-200">
    ...
    21: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col rounded-[3px] overflow-hidden p-2 justify-center" style={{ background: accent }}>
    ...
    23: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col p-2 rounded-[3px] overflow-hidden bg-zinc-100">
    ...
    25: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col p-2 rounded-[3px] overflow-hidden bg-white relative">
    ...
    28: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col items-center justify-center rounded-[3px] overflow-hidden bg-zinc-950 p-2 relative">
    ...
    29: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col rounded-[3px] overflow-hidden bg-zinc-950 p-1 border-[3px]" style={{ borderColor: accent }}>
    ...
    30: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col rounded-[3px] overflow-hidden bg-zinc-950 p-2 relative">
    ...
    32: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col rounded-[3px] overflow-hidden bg-[#050505] p-2">
    ...
    38: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col p-1 rounded-[3px] overflow-hidden relative" style={{ background: accent }}>
    ...
    39: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col p-1.5 rounded-[3px] overflow-hidden relative" style={{ background: accent }}>
      ...
      <div className="w-full h-full flex flex-col rounded-[3px] overflow-hidden relative bg-white">
        ...
        <div className="flex-1 flex flex-col justify-center p-2 relative z-10 gap-1.5">
           <div className="flex items-center gap-1 mt-2">
              <div className="w-4 h-4 rounded-[3px] bg-black/20 border border-white/30" />
    ...
    41: ({ brandColor: accent }) => (
      <div className="w-full h-full flex flex-col rounded-[3px] overflow-hidden bg-black relative">
