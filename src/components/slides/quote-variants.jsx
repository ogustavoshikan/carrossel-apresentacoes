...
export const QUOTE_VARIANT_META = [
  { id: 0, name: 'Original', description: 'Layout quote padrão centralizado', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote0.png' },
  { id: 1, name: 'Classic Dark', description: 'Escuro com ícone de aspas e detalhe lateral', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote1.png' },
  { id: 2, name: 'Blur Movie', description: 'Imagem desfocada com gradiente e logo', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote2.png' },
  { id: 3, name: 'Brand Main', description: 'Fundo da cor da marca com citação centralizada e gigante', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote3.png' },
  { id: 4, name: 'Side Dark', description: 'Imagem escura na esquerda, texto claro na direita', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote4.png' },
  { id: 5, name: 'Bento Card', description: 'Card vidro com ícone deslocado no topo', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote5.png' },
  { id: 6, name: 'Simple Top', description: 'Simples com detalhe na barra superior', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote6.png' },
  { id: 7, name: 'White Box', description: 'Card branco com bordas brutais flutuantes', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote7.png' },
  { id: 8, name: 'Vertical Auth', description: 'Sidebar esticada colorida com autor rotacionado', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote8.png' },
  { id: 9, name: 'Gradient Text', description: 'Texto gigante com preenchimento em gradiente brilhante', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote9.png' },
  { id: 10, name: 'Glass Card', description: 'Card vidro desfocado em fundo fotográfico', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote10.png' },
  { id: 11, name: 'Light Print', description: 'Estilo editorial impresso com citação ao fundo', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote11.png' },
  { id: 12, name: 'Social Proof', description: 'Depoimento premium com balão e avatar', thumbnailUrl: '/thumbnails/Thumbnails%20Citacao/designs_quote12.png' }
];
