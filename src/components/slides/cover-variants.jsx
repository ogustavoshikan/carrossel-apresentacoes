...
export const COVER_VARIANT_META = [
  {
    ...
    thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa_-0.png'
  },
  { id: 1, name: 'Color Split', description: 'Imagem + bloco de cor', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs-capa-1.png' },
  { id: 2, name: 'Cinemático', description: 'Full-bleed com gradient', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-2.png' },
  { id: 3, name: 'Blur Editorial', description: 'Fundo blur + barra de acento', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-3.png' },
  { id: 4, name: 'Moldura', description: 'Estilo editorial emoldurado', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa--4.png' },
  { id: 5, name: 'Rounded Split', description: 'Bloco arredondado de cor', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-5.png' },
  { id: 6, name: 'Arco', description: 'Imagem em arco + texto central', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-6.png' },
  { id: 7, name: 'Polaroid', description: 'Card estilo foto instantânea', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-7.png' },
  { id: 8, name: 'Acento Lateral', description: 'Borda lateral colorida', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-8.png' },
  { id: 9, name: 'Spotlight', description: 'Card branco com watermark', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-9.png' },
  { id: 10, name: 'Bottom Minimal', description: 'Texto inferior minimalista', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa--10.png' },
  { id: 11, name: 'Luxury Frame', description: 'Moldura branca com sombra profunda', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-11.png' },
  { id: 12, name: 'Diagonal Slice', description: 'Corte diagonal dinâmico', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-12.png' },
  { id: 13, name: 'Bold Overlay', description: 'Título com mix-blend e badge', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-13.png' },
  { id: 14, name: 'Top Block', description: 'Bloco de cor superior e imagem', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-14.png' },
  { id: 15, name: 'Center Card', description: 'Imagem superior e card central', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-15.png' },
  { id: 16, name: 'Bottom Gradient', description: 'Imagem full com gradient colorido', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa--16.png' },
  { id: 17, name: 'Minimal Side', description: 'Divisão lateral limpa', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-17.png' },
  { id: 18, name: 'Glassmorphism Center', description: 'Card com blur sobre glow', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs-capa-18.png' },
  { id: 19, name: 'Arch Featured', description: 'Imagem em arco com badge', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-19.png' },
  { id: 20, name: 'Rotating Polaroid', description: 'Polaroid com padrão radial', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-20.png' },
  { id: 21, name: 'Diagonal Edge', description: 'Corte diagonal com título gigante', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-21.png' },
  { id: 22, name: 'Header Minimal', description: 'Título uppercase com glow lateral', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa22.png' },
  { id: 23, name: 'Vertical Split', description: 'Split vertical com handle rotacionado', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-23.png' },
  { id: 24, name: 'Grid Process', description: 'Estilo técnico com grid e badge', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-24.png' },
  { id: 25, name: 'Frosted Float', description: 'Card flutuante com blur intenso', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa25.png' },
  { id: 26, name: 'Overlay Volume', description: 'Bloco superior blend sobre imagem', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-26.png' },
  { id: 27, name: 'Slanted New', description: 'Recorte diagonal com ícone Sparkles', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-27.png' },
  { id: 28, name: 'Right Image Text Left', description: 'Imagem à direita com texto à esquerda', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa--28.png' },
  { id: 29, name: 'Framed Left Image', description: 'Imagem emoldurada com tags à direita', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-29.png' },
  { id: 30, name: 'Social Icons Overlay', description: 'Layout com barra de ícones de redes sociais', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-30.png' },
  { id: 31, name: 'List Bullet Stars', description: 'Imagem com lista de destaques', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-31.png' },
  { id: 32, name: 'Repeated Text Background', description: 'Fundo com texto repetido e card inferior', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-32.png' },
  { id: 33, name: 'Gradient Footer', description: 'Imagem superior com rodapé colorido e divisória', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-33.png' },
  { id: 34, name: 'Center Focus', description: 'Fundo escuro com texto centralizado e header', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-34.png' },
  { id: 35, name: 'Curve Card', description: 'Card branco inferior com topo arredondado', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-35.png' },
  { id: 36, name: 'Magazine Split', description: 'Texto à esquerda e imagem à direita estilo revista', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-36.png' },
  { id: 37, name: 'Modern Frame', description: 'Fundo colorido com card de imagem central', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-37.png' },
  { id: 38, name: 'Gradient Bottom', description: 'Imagem full com gradient e tags inferiores', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-38.png' },
  { id: 39, name: 'Side Strip', description: 'Imagem lateral com faixa de marca vertical', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-39.png' },
  { id: 40, name: 'Floating Card Center', description: 'Imagem superior e card flutuante centralizado', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-40.png' },
  { id: 41, name: 'Slanted Banner', description: 'Faixa diagonal sobre imagem grayscale', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-41.png' },
  { id: 42, name: 'Upper Frame Title', description: 'Título superior emoldurado e rodapé branco minimalista', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-42.png' },
  { id: 43, name: 'Repeat Text Focus', description: 'Texto repetido ao fundo com card de imagem central', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-43.png' },
  { id: 44, name: 'Floating Bubbles', description: 'Bolhas flutuantes com imagem e texto lateral elegante', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-44.png' },
  { id: 45, name: 'Vertical Mirror CTA', description: 'Split vertical com CTA de arraste', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-45.png' },
  { id: 46, name: 'Horizontal Mirror CTA', description: 'Split horizontal com CTA de arraste', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs-capa-46.png' },
  { id: 48, name: 'Split Number Dark', description: 'Fundo colorido com imagem superior e número gigante', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-48.png' },
  { id: 49, name: 'Split Vert Typo', description: 'Divisão vertical com imagem e número gigante blend', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-49.png' },
  { id: 50, name: 'Massive Typo Frame', description: 'Moldura colorida com card de imagem e título de impacto', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-50.png' },
  { id: 51, name: 'Solid Half Brand', description: 'Meio a meio sólido com título vazado para fora', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-51.png' },
  { id: 52, name: 'Brand Dominance', description: 'Bloco de cor dominante e imagem grayscale', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-52.png' },
  { id: 53, name: 'Sharp Half Block', description: 'Divisão ao meio com bloco sólido e CTA', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa53.png' },
  { id: 54, name: 'Bold Brand Frame', description: 'Moldura colorida lateral com título impactante', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-54.png' },
  { id: 55, name: 'Premium Edge', description: 'Barra lateral informativa e card de imagem', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa55.png' },
  { id: 56, name: 'Split Typo Hero', description: 'Imagem superior e bloco informativo inferior', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa56.png' },
  { id: 57, name: 'Author Focus', description: 'Focado no autor com imagem circular e card', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-57.png' },
  { id: 58, name: 'Author Clean', description: 'Minimalista com foco em cor e autor', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-58.png' },
  { id: 59, name: 'Author Profile', description: 'Layout escuro com autor centralizado', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa-59.png' },
  { id: 60, name: 'Author Elegant', description: 'Elegante com borda e autor lateral', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa60.png' },
  { id: 61, name: 'Author Centered', description: 'Centralizado com autor no topo e fundo escuro', thumbnailUrl: '/thumbnails/Thumbnails%20Capas/designs_capa61.png' },
  ];
