...
export const BIGNUMBER_VARIANT_META = [
  { 
    ...
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--0.png'
  },
  { 
    id: 1, 
    name: 'Dark Stack', 
    description: 'Número grande + tag pill + imagem arredondada',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--1.png'
  },
  { 
    id: 2, 
    name: 'Phantom', 
    description: 'Número central com ghost gigante atrás',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--2.png'
  },
  { 
    id: 3, 
    name: 'Color Block', 
    description: 'Bloco colorido superior + texto escuro abaixo',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--3.png'
  },
  { 
    id: 5, 
    name: 'Side Panel', 
    description: 'Número à esquerda + painel de texto',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--5.png'
  },
  { 
    id: 7, 
    name: 'Texture Fill', 
    description: 'Número preenchido com textura da imagem',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--7.png'
  },
  { 
    id: 8, 
    name: 'Outline Float', 
    description: 'Número outline flutuando + imagem inferior',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--8.png'
  },
  { 
    id: 9, 
    name: 'Sidebar', 
    description: 'Faixa lateral colorida com número rotacionado',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--9.png'
  },
  { 
    id: 10, 
    name: 'Magazine', 
    description: 'Imagem superior + número sobreposto + cor',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--10.png'
  },
  { 
    id: 13, 
    name: 'Elegant Glow', 
    description: 'Número central branco com glow da marca',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--13.png'
  },
  {
    id: 14,
    name: 'Texture Number',
    description: 'Número preenchido com textura de imagem em fundo claro',
    thumbnailUrl: '/thumbnails/Thumbnail%20Bignumber/designs_bignumber-variants--14.png'
  },
