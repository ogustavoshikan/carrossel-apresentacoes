...
export const CTA_VARIANT_META = [
  { id: 4, name: 'Ticket Card', title: 'Ticket Card', description: 'Card destacado estilo ticket picotado', desc: 'Card destacado estilo ticket picotado', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta-4.png' },
  { id: 5, name: 'Blur Tilt', title: 'Blur Tilt', description: 'Efeito de desfoque e rotação suave', desc: 'Efeito de desfoque e rotação suave', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta5.png' },
  { id: 6, name: 'Clean Typographic', title: 'Clean Typographic', description: 'Layout minimalista puramente tipográfico', desc: 'Layout minimalista puramente tipográfico', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta6.png' },
  { id: 7, name: 'App Interface', title: 'App Interface', description: 'Design lembrando uma interface de agendamento', desc: 'Design lembrando uma interface de agendamento', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta7.png' },
  { id: 14, name: 'Store Dashed', title: 'Store Dashed', description: 'Ícone de loja com borda tracejada e botão outline', desc: 'Ícone de loja com borda tracejada e botão outline', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta14.png' },
  { id: 16, name: 'VIP Border', title: 'VIP Border', description: 'Borda tracejada estilo ingresso com acesso VIP', desc: 'Borda tracejada estilo ingresso com acesso VIP', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta16.png' },
  { id: 18, name: 'Polaroid Tilt', title: 'Polaroid Tilt', description: 'Foto estilo polaroid inclinada sobre fundo colorido', desc: 'Foto estilo polaroid inclinada sobre fundo colorido', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta18.png' },
  { id: 19, name: 'Social Blur', title: 'Social Blur', description: 'Rodapé com blur e ícones sociais destacados', desc: 'Rodapé com blur e ícones sociais destacados', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta19.png' },
  { id: 20, name: 'Floating Polaroid', title: 'Floating Polaroid', description: 'Card polaroid rotacionado sobre fundo claro', desc: 'Card polaroid rotacionado sobre fundo claro', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta20.png' },
  { id: 21, name: 'Bookmark Focus', title: 'Bookmark Focus', description: 'Destaque no ícone de salvar com fundo escuro', desc: 'Destaque no ícone de salvar com fundo escuro', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta21.png' },
  { id: 22, name: 'Editorial Side', title: 'Editorial Side', description: 'Layout de revista com barra lateral de ações', desc: 'Layout de revista com barra lateral de ações', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta22.png' },
  { id: 23, name: 'Bento Grid', title: 'Bento Grid', description: 'Grade estilo bento com ações e botão de arraste', desc: 'Grade estilo bento com ações e botão de arraste', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta23.png' },
  { id: 24, name: 'Cinema Overlay', title: 'Cinema Overlay', description: 'Overlay cinematográfico sobre imagem de fundo', desc: 'Overlay cinematográfico sobre imagem de fundo', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta24.png' },
  { id: 25, name: 'Giant Watermark', title: 'Giant Watermark', description: 'Marca d\'água gigante com ícone de salvar ao fundo', desc: 'Marca d\'água gigante com ícone de salvar ao fundo', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta25.png' },
  { id: 29, name: 'Bold Frame', title: 'Bold Frame', description: 'Moldura espessa na cor da marca com foco centralizado', desc: 'Moldura espessa na cor da marca com foco centralizado', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta29.png' },
  { id: 31, name: 'Floating Bar', title: 'Floating Bar', description: 'Divisão de cores contrastantes com barra de ações centralizada', desc: 'Divisão de cores contrastantes com barra de ações centralizada', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta31.png' },
  { id: 33, name: 'Sidebar Glossy', title: 'Sidebar Glossy', description: 'Barra lateral de ações com fundo glassmorphism e gradiente suave', desc: 'Barra lateral de ações com fundo glassmorphism e gradiente suave', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta33.png' },
  { id: 34, name: 'Floating Capsule', title: 'Floating Capsule', description: 'Cápsula flutuante de ações em glassmorphism claro', desc: 'Cápsula flutuante de ações em glassmorphism claro', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta34.png' },
  { id: 36, name: 'Creator Bar', title: 'Creator Bar', description: 'Barra de criador com perfil circular e ações rápidas', desc: 'Barra de criador com perfil circular e ações rápidas', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta36.png' },
  { id: 37, name: 'Split Modern', title: 'Split Modern', description: 'Layout dividido moderno com topo arredondado e imagem flutuante', desc: 'Layout dividido moderno com topo arredondado e imagem flutuante', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta-37.png' },
  { id: 40, name: 'Split Tilt Profile', title: 'Split Tilt Profile', description: 'Divisão diagonal com perfil em destaque e botões arredondados', desc: 'Divisão diagonal com perfil em destaque e botões arredondados', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta40.png' },
  { id: 41, name: 'Vertical Color Block', title: 'Vertical Color Block', description: 'Blocos de cores verticais com perfil flutuante lateral', desc: 'Blocos de cores verticais com perfil flutuante lateral', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta-41.png' },
  { id: 42, name: 'Center Focus Round', title: 'Center Focus Round', description: 'Topo com imagem e corpo colorido arredondado com foco no perfil', desc: 'Topo com imagem e corpo colorido arredondado com foco no perfil', thumbnailUrl: '/thumbnails/Thumbnails%20CTA/designs_cta42.png' },
];
