...
export function CTAVariant37(props) {
  ...
  return (
    <div className="w-full h-full flex flex-col relative bg-white">
      ...
      <div className="h-[55%] w-full p-8 flex flex-col justify-end pt-12 relative z-0 rounded-t-[25px] shadow-[0_-20px_40px_rgba(0,0,0,0.3)] -mt-4 text-black border-t" style={{ background: `linear-gradient(${brandColor + '21'}, ${brandColor + '21'}), white`, borderColor: brandColor + '21' }}>
        <SmartElement
          slideIndex={index}
          field="titulo"
          position={pos('titulo')}
        ...
        >
          <p
            ...
            suppressContentEditableWarning
            onBlur={(e) => onTextChange(index, 'texto_apoio', e.currentTarget.innerText)}
            className="font-text font-medium leading-relaxed outline-none"
            style={{ fontSize: `${15 * sText}px`, color: '#101010' }}
          >
            {data.texto_apoio}
          </p>
        </SmartElement>
      ...
      <div className="absolute top-[45%] right-8 -translate-y-1/2 w-24 h-24 rounded-2xl border-[4px] overflow-hidden z-20 rotate-3" style={{ background: `linear-gradient(${brandColor + '21'}, ${brandColor + '21'}), white`, borderColor: brandColor, boxShadow: `0 10px 30px ${brandColor}40` }}>
...
export function CTAVariant41(props) {
  ...
  return (
    <div className="w-full h-full flex flex-col relative bg-white text-black">
      <div className="h-[50%] w-full flex flex-col p-8 pb-16 relative z-0 text-white" style={{fontFamily: textFont,  backgroundColor: brandColor }}>
        <div className="absolute inset-0 bg-black/10 mix-blend-overlay" />
        <SlideHeader 
          {...props} 
          slideIndex={index} 
      ...
      <div className="h-[50%] w-full flex flex-col p-8 pt-16 relative z-0 border-t-2 border-white/10" style={{ backgroundColor: brandColor + '21' }}>
        <SmartElement
          slideIndex={index}
          field="texto_apoio"
          position={pos('texto_apoio')}
        ...
        >
          <p
            ...
            onBlur={(e) => onTextChange(index, 'texto_apoio', e.currentTarget.innerText)}
            className="font-text font-medium leading-relaxed outline-none"
            style={{ fontSize: `${18 * sText}px`, color: '#101010' }}
          >
            {data.texto_apoio}
          </p>
        </SmartElement>
        <div 
          className="flex justify-between items-center w-full mt-auto p-3 rounded-2xl border border-white/70"
          style={{ 
            backgroundColor: brandColor + '10',
            boxShadow: `0 15px 35px ${brandColor}33`
          }}
        >
      ...
      <div className="absolute top-1/2 right-8 -translate-y-1/2 w-24 h-24 rounded-[2rem] border-[4px] overflow-hidden z-20 bg-zinc-800 rotate-6" style={{ borderColor: brandColor, boxShadow: `0 10px 30px ${brandColor}40` }}>
        <div className="w-full h-full flex items-center justify-center">
...
export const CTA_VARIANT_META = [
  { id: 4, name: 'Ticket Card', title: 'Ticket Card', description: 'Card destacado estilo ticket picotado', desc: 'Card destacado estilo ticket picotado', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta-4.png' },
  { id: 5, name: 'Blur Tilt', title: 'Blur Tilt', description: 'Efeito de desfoque e rotação suave', desc: 'Efeito de desfoque e rotação suave', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta5.png' },
  { id: 6, name: 'Clean Typographic', title: 'Clean Typographic', description: 'Layout minimalista puramente tipográfico', desc: 'Layout minimalista puramente tipográfico', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta6.png' },
  { id: 7, name: 'App Interface', title: 'App Interface', description: 'Design lembrando uma interface de agendamento', desc: 'Design lembrando uma interface de agendamento', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta7.png' },
  { id: 14, name: 'Store Dashed', title: 'Store Dashed', description: 'Ícone de loja com borda tracejada e botão outline', desc: 'Ícone de loja com borda tracejada e botão outline', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta14.png' },
  { id: 16, name: 'VIP Border', title: 'VIP Border', description: 'Borda tracejada estilo ingresso com acesso VIP', desc: 'Borda tracejada estilo ingresso com acesso VIP', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta16.png' },
  { id: 18, name: 'Polaroid Tilt', title: 'Polaroid Tilt', description: 'Foto estilo polaroid inclinada sobre fundo colorido', desc: 'Foto estilo polaroid inclinada sobre fundo colorido', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta18.png' },
  { id: 19, name: 'Social Blur', title: 'Social Blur', description: 'Rodapé com blur e ícones sociais destacados', desc: 'Rodapé com blur e ícones sociais destacados', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta19.png' },
  { id: 20, name: 'Floating Polaroid', title: 'Floating Polaroid', description: 'Card polaroid rotacionado sobre fundo claro', desc: 'Card polaroid rotacionado sobre fundo claro', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta20.png' },
  { id: 21, name: 'Bookmark Focus', title: 'Bookmark Focus', description: 'Destaque no ícone de salvar com fundo escuro', desc: 'Destaque no ícone de salvar com fundo escuro', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta21.png' },
  { id: 22, name: 'Editorial Side', title: 'Editorial Side', description: 'Layout de revista com barra lateral de ações', desc: 'Layout de revista com barra lateral de ações', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta22.png' },
  { id: 23, name: 'Bento Grid', title: 'Bento Grid', description: 'Grade estilo bento com ações e botão de arraste', desc: 'Grade estilo bento com ações e botão de arraste', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta23.png' },
  { id: 24, name: 'Cinema Overlay', title: 'Cinema Overlay', description: 'Overlay cinematográfico sobre imagem de fundo', desc: 'Overlay cinematográfico sobre imagem de fundo', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta24.png' },
  { id: 25, name: 'Giant Watermark', title: 'Giant Watermark', description: 'Marca d\'água gigante com ícone de salvar ao fundo', desc: 'Marca d\'água gigante com ícone de salvar ao fundo', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta25.png' },
  { id: 29, name: 'Bold Frame', title: 'Bold Frame', description: 'Moldura espessa na cor da marca com foco centralizado', desc: 'Moldura espessa na cor da marca com foco centralizado', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta29.png' },
  { id: 31, name: 'Floating Bar', title: 'Floating Bar', description: 'Divisão de cores contrastantes com barra de ações centralizada', desc: 'Divisão de cores contrastantes com barra de ações centralizada', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta31.png' },
  { id: 32, name: 'Centered Impact', title: 'Centered Impact', description: 'Card central de alto impacto sobre fundo dark', desc: 'Card central de alto impacto sobre fundo dark', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta32.png' },
  { id: 33, name: 'Sidebar Glossy', title: 'Sidebar Glossy', description: 'Barra lateral de ações com fundo glassmorphism e gradiente suave', desc: 'Barra lateral de ações com fundo glassmorphism e gradiente suave', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta33.png' },
  { id: 34, name: 'Floating Capsule', title: 'Floating Capsule', description: 'Cápsula flutuante de ações em glassmorphism claro', desc: 'Cápsula flutuante de ações em glassmorphism claro', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta34.png' },
  { id: 35, name: 'Bottom Dock', title: 'Bottom Dock', description: 'Dock inferior with ações e destaque no botão salvar', desc: 'Dock inferior with ações e destaque no botão salvar', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta35.png' },
  { id: 36, name: 'Creator Bar', title: 'Creator Bar', description: 'Barra de criador com perfil circular e ações rápidas', desc: 'Barra de criador com perfil circular e ações rápidas', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta36.png' },
  { id: 37, name: 'Split Modern', title: 'Split Modern', description: 'Layout dividido moderno com topo arredondado e imagem flutuante', desc: 'Layout dividido moderno com topo arredondado e imagem flutuante', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta37.png' },
  { id: 38, name: 'Rounded Card Premium', title: 'Rounded Card Premium', description: 'Card branco arredondado sobre fundo colorido com perfil centralizado', desc: 'Card branco arredondado sobre fundo colorido com perfil centralizado', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta38.png' },
  { id: 39, name: 'Overlay Glass Profile', title: 'Overlay Glass Profile', description: 'Layout com gradiente e barra de ações dark no rodapé', desc: 'Layout com gradiente e barra de ações dark no rodapé', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta39.png' },
  { id: 40, name: 'Split Tilt Profile', title: 'Split Tilt Profile', description: 'Divisão diagonal com perfil em destaque e botões arredondados', desc: 'Divisão diagonal com perfil em destaque e botões arredondados', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta40.png' },
  { id: 41, name: 'Vertical Color Block', title: 'Vertical Color Block', description: 'Blocos de cores verticais com perfil flutuante lateral', desc: 'Blocos de cores verticais com perfil flutuante lateral', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta41.png' },
  { id: 42, name: 'Center Focus Round', title: 'Center Focus Round', description: 'Topo com imagem e corpo colorido arredondado com foco no perfil', desc: 'Topo com imagem e corpo colorido arredondado com foco no perfil', thumbnailUrl: 'https://wpkufemyqzwkylrfkihp.supabase.co/storage/v1/object/public/Carrossel%20Studio/Thumbnails%20CTA/designs_cta42.png' },
];
