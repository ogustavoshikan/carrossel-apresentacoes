...
export const CONTENT_EXTRA_VARIANT_META = [
  { id: 252, name: 'Refresh', description: 'Layout Refresh com caixa de destaque lateral direita superior e imagem de fundo inteira', thumbnailUrl: '' },
  { id: 253, name: 'Fidelize', description: 'Layout Fidelize com header de avatar, faixa vertical direita e aba inferior de footer', thumbnailUrl: '' },
  { id: 254, name: 'May Option', description: 'Layout May Option com linha vertical dourada, card centralizado e pill superior indicativo', thumbnailUrl: '' },
  { id: 255, name: 'BNI Card', description: 'Layout BNI Card com barra lateral esquerda destacada, logo e dois cards sobrepostos com imagem flutuante', thumbnailUrl: '' },
  { id: 256, name: 'Bubble', description: 'Layout Bubble com sparkles e cursor em destaque, título centralizado e imagem em destaque', thumbnailUrl: '' },
  { id: 257, name: 'Quote Highlight', description: 'Layout Quote com autor destacado, citação no topo com marcação especial e imagem de fundo inferior', thumbnailUrl: '' },
  { id: 258, name: 'Alerta de Post', description: 'Layout Alerta de Post com mockup de celular interativo mostrando o post do feed e adesivo flutuante', thumbnailUrl: '' },
  { id: 259, name: 'Caixa Presente', description: 'Layout Caixa Presente com logo superior, produto em moldura rotacionada 3D e badge flutuante', thumbnailUrl: '' },
  { id: 260, name: 'Quote Minimalista', description: 'Layout Quote Minimalista com aspas gigantes de fundo, autor com cargo destacado e produto abaixo com logo', thumbnailUrl: '' },
  { id: 261, name: 'Padrão Brutalista', description: 'Layout Padrão Brutalista com textos em repetição ao fundo na diagonal e produto/PNG centralizado', thumbnailUrl: '' },
  { id: 262, name: 'Corp. Checklist', description: 'Layout Corp. Checklist corporativo com logo central, título em destaque e três cards com ícone check', thumbnailUrl: '' },
  { id: 263, name: 'Corp. Palestrante', description: 'Layout Corp. Palestrante com faixa lateral, título grande, dois cards de texto e palestrante/PNG destacado à direita', thumbnailUrl: '' },
  { id: 264, name: 'Divisão Diagonal', description: 'Layout Divisão Diagonal Clássica com a metade esquerda em clip-path de imagem e metade direita com texto editável', thumbnailUrl: '' },
  { id: 265, name: 'Clássico Vazando', description: 'Layout O Clássico com palavra gigante em marca d\'água de fundo, imagem enquadrada com cantos arredondados e texto ao lado', thumbnailUrl: '' },
  { id: 266, name: 'Party People', description: 'Layout Party People com faixa lateral sólida, título gigante rotacionado na vertical sobreposto e card de informações sobre a imagem', thumbnailUrl: '' },
  { id: 267, name: 'Cinnamon Roll', description: 'Layout Cinnamon Roll com texto arqueado rotativo, badge inferior, imagens e rodapé duplo com corações', thumbnailUrl: '' },
  { id: 268, name: 'LAB5 (Novo)', description: 'Layout LAB5 com topo de imagem inteira de fundo e base colorida ondulada com botão seta', thumbnailUrl: '' },
  { id: 269, name: 'Sucesso', description: 'Layout Sucesso com topo de imagem lateral integrada e base colorida em onda contendo 4 cards de ícone', thumbnailUrl: '' },
  { id: 270, name: 'Brownie', description: 'Layout Brownie com fundo decorado, título marcante em destaque, rodapé ondulado e caixas flutuantes', thumbnailUrl: '' },
