          ...
          <div className="space-y-3 relative z-10 overflow-y-auto">
            {items.map((item, i) => (
              <div key={i} className="flex gap-5 items-center group">
                ...
                <div className="p-2.5 rounded-xl flex-1" style={{ backgroundColor: '#000000', border: `1px solid ${brandColor}40` }}>
    ...
    <div className="w-full h-full bg-black flex flex-col p-10 relative items-center text-center">
      ...
      <div className="flex-1 flex flex-wrap content-start justify-center gap-2 pt-2 w-full relative z-10">
        ...
        <div className="w-full mt-2 space-y-2">
          {items.map((item, i) => (
            <div key={`text-${i}`} className="w-full p-3 rounded-3xl group text-center" style={{ backgroundColor: '#000000', border: `1px solid ${brandColor}40` }}>
