...
/**
 * CoverVariantPopover — Grid visual com mini-wireframes de cada variante de capa.
 * Abre acima do botão "Variante".
 */
export default function CoverVariantPopover({
  currentVariantIndex,
  onSelect,
  onClose,
  brandColor,
    ...
    >
      <div className="bg-zinc-950/95 backdrop-blur-xl border border-zinc-800/80 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] p-4 min-w-[280px]">
        ...
        <VariantPopoverHeader
          ...
          activeLabel={COVER_VARIANT_META.find(v => v.id === currentVariantIndex)?.name || 'Original'}
          onClose={onClose}
        />
