    ...
    37: (
      <div className="w-full h-full flex flex-col rounded-[3px] overflow-hidden bg-[#EBE9E1]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-1 relative z-10">
          <div className="w-5 h-5 rounded-full border border-white/20 bg-white/10" />
          <div className="w-[70%] h-[2.5px] bg-white rounded-full mt-1" />
        </div>
