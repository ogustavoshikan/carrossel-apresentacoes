...
export default function BigNumberVariantPopover({ currentVariantIndex, onSelect, onClose, brandColor, brandAvatar }) {
    ...
    >
      <div className="bg-zinc-950/95 backdrop-blur-xl border border-zinc-800/80 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.6)] p-4 min-w-[320px]">
        ...
        <VariantPopoverHeader
          label="Variante do Big-Number"
          activeLabel={currentVariantIndex === 0 ? 'Original' : BIGNUMBER_VARIANT_META.find(v => v.id === currentVariantIndex)?.name}
          onClose={onClose}
        />
